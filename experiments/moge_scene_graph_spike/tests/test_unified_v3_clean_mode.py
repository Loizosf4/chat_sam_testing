...
def test_required_clean_outputs_and_per_object_diagnostics(unified_pair):
    ...
    required={"unified_scene_plan.json","unified_scene_plan.md","room_plan.json","camera_candidates.json","object_pose_report.json","object_pose_report.md","placement_report.json","support_graph.json","collision_report.json","confidence_report.json","ambiguity_report.md","clean_input_audit.json","forbidden_input_audit.json","compilation_report.json","compilation_report.md","blender_one_batch_manifest.json","numbered_object_overlay.png","normal_frames_overlay.png","projected_primitives_overlay.png","support_graph_overlay.png","room_and_camera_overlay.png","room_projection_overlay.png","confidence_overview.png","ambiguity_overview.png","clean_scene_plan_overview.png"}
